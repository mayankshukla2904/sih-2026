...
**Headline numbers (chip still 20 Sep 2026 22:46 IST INT8; pack dated 21 Sep):** idle listen **0.4% CPU**, RAM **187.6 KB**, INT8 **42.1 KB**. Deployed knobs **0.65 / 3 / 3**. Firmware-faithful TPR **0.80** at **15 FA/h** on **290** S3-mic keyword clips. Disk now has **330** keyword clips (210 close + 80 at 1 m + 40 at 3 m), **189** unknown, **45** lookalike, **55** silence, **4** noise (including a 10 min room take). Those extra clips are **not** in `tuning.json` and are **not** on the chip. Live TPR/FAR at 0.65 not re-measured. Keyword-end → ASR latency unmeasured. Tiny always-on keyword net **not** shipped.
